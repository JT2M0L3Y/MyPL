...
//----------------------------------------------------------------------
// 10 Custom Negative Tests: 
//----------------------------------------------------------------------

TEST(AddedNegativeTests, ToIntBoolArg) 
{
  stringstream in(build_string({
    "void main() {",
    "  int x = to_int(true)",
...
TEST(AddedNegativeTests, ToDoublePassedChar)
{
  stringstream in(build_string({
    "void main() {",
...
TEST(AddedNegativeTests, StructTypeConversion)
{
  stringstream in(build_string({
    "struct S {int x, double y}"
    "void main() {",
    "  double i = to_double(S)"
    "}"
  }));
  SemanticChecker checker;
  try
...
TEST(AddedNegativeTests, PrintCallEmpty)
{
  stringstream in(build_string({
    "void main() {",
    "  print()",
...
TEST(AddedNegativeTests, RepeatPathAccess)
{
  stringstream in(build_string({
    "struct S {array int arr, S x}",
    "void main() {",
    "  s.arr[0].arr[0] = 1",
    "}"
  }));
...
TEST(AddedNegativeTests, NonIntInForVarDecl)
{
  stringstream in(build_string({
    "void main() {",
...
TEST(AddedNegativeTests, IfObjOutsideOfScope)
{
  stringstream in(build_string({
    "void main() {",
    "  int x = 5",
...
TEST(AddedNegativeTests, NegatingNewStruct)
{
  stringstream in(build_string({
    "struct S {int x, double y}",
    "void main() {",
...
TEST(AddedNegativeTests, ForConditionMismatch)
{
  stringstream in(build_string({
      "void main() {",
      "  for (int i = 0; i < 5.3; i = i + 1) {}"
      "}"
  }));
  SemanticChecker checker;
  try
...
TEST(AddedNegativeTests, ConcatInFunctionArgTypes)
{
  stringstream in(build_string({
    "string f(string x, char c) {",
    "  string s = concat(x, c)",
    "  return concat(x, to_string(c))"
    "}",
    "void main() {}"
  }));
  SemanticChecker checker;
